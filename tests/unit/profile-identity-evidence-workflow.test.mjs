...
const page = fs.readFileSync(new URL('../../app/telemetry/devices/profile-identity/page.tsx', import.meta.url), 'utf8');
...
test('device management exposes the profile identity review workspace', () => {
