...
3. If the manager replies, normal operation starts automatically.
...
7. Future reader plug-ins require no setup; the manager answers the handshake automatically.

## Normal use

- Scan the first card: `http://localhost:8765` opens automatically.
- Scan additional cards: each scan is appended to the table without opening another browser tab while the page is active.
