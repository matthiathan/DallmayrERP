...
export default function StockItemProfilePage() {
  ...
  return (
    <AppShell>
      ...
      {!item ? <div className="neo-card"><h1>Stock item not found</h1><Link className="button" href="/warehouse/stock">Back to stock</Link></div> : <div className="grid spatial-stage spatial-dashboard erp-record-workspace erp-stock-item-workspace">
