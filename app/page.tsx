  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        setNotice(supplementaryError ? 'Core dashboard totals are live. Recent activity or alert summaries could not be fully refreshed.' : null);
      ...
      <section className="admin-command-dashboard admin-reference-dashboard">
        ...
        <section className="admin-reference-lower-grid">
          <section className="admin-reference-panel" aria-labelledby="recent-activity-title">
            <header><h2 id="recent-activity-title">Recent Activity</h2><Link href="/admin/activity">View all</Link></header>
          ...
          <section className="admin-reference-panel" aria-labelledby="dashboard-alerts-title">
            <header><h2 id="dashboard-alerts-title">Alerts</h2><Link href="/work">View all</Link></header>
            <div className="admin-reference-panel-list">
              {alertRows.map((item) => (
