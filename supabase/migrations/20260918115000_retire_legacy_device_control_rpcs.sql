...
revoke execute on function public.set_telemetry_device_control(text, text, boolean, boolean) from authenticated;
revoke execute on function public.set_telemetry_device_control(text, text, boolean, boolean) from public, anon;
grant execute on function public.set_telemetry_device_control(text, text, boolean, boolean) to service_role;
