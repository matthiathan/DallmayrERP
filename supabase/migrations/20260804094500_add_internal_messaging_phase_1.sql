-- Phase 1 internal messaging foundation.
-- This migration is intentionally limited to durable text messaging, membership,
-- read positions, audit events, and secure thread-creation RPCs.
