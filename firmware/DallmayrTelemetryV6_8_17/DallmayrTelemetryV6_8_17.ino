/*
  Dallmayr South Africa - Telemetry V6.8.17 DB-POLICY NATIVE MDB + DEX
...
static const char* FIRMWARE_VERSION = "6.8.17-esp32s3-vodacom-111-502-balance";
...
void printStatus() {
  Serial.println(F("--- Dallmayr Telemetry V6.8.17 VODACOM *111*502# BALANCE DB-POLICY NATIVE MDB + DEX ---"));
...
void setup() {
  ...
  delay(2000);
  Serial.println();
  Serial.println(F("Dallmayr Telemetry V6.8.17 - DB-POLICY NATIVE PASSIVE MDB + DEX + WIFI/CELLULAR"));
#if defined(ARDUINO_USB_CDC_ON_BOOT) && ARDUINO_USB_CDC_ON_BOOT
