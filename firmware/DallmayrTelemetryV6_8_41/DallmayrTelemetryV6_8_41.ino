/*
  Dallmayr South Africa - Telemetry V6.8.41 DB-POLICY NATIVE MDB + DEX
...
static const char* FIRMWARE_VERSION = "6.8.41-esp32s3-air780eu-remote-test-center";
...
// Keep the MCU wait longer than the modem deadline. V6.8.41 deliberately uses
...
void printStatus() {
  Serial.println(F("--- Dallmayr Telemetry V6.8.41 AUTO-PROFILE CUP-COUNTERS DB-POLICY NATIVE MDB + DEX ---"));
...
void setup() {
  ...
  delay(2000);
  Serial.println();
  Serial.println(F("Dallmayr Telemetry V6.8.41 - PASSIVE MDB + DEX + AUTO-PROFILE EVIDENCE + CUP COUNTERS + WIFI/MANUAL PPPOS"));
#if defined(ARDUINO_USB_CDC_ON_BOOT) && ARDUINO_USB_CDC_ON_BOOT
