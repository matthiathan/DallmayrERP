...
export function ExecutiveReportingPanel() {
  ...
  if (loading) {
    return <div className="neo-card"><h2>Loading reporting metrics...</h2><p>Preparing branch and department dashboards.</p></div>;
  }
  ...
  return (
    <div className="grid">
      ...
      <div className="grid grid-2">
        ...
        <DonutChart title="Operational work captured" data={[{ label: 'Task closures', value: kpis[3].value }, { label: 'Delivery orders', value: kpis[4].value }, { label: 'Stock scans', value: Object.values(metrics.stockScans).reduce((sum, value) => sum + value, 0) }]} />
