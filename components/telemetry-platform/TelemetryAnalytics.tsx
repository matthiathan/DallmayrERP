...
export function TelemetryAnalytics(){
  ...
  return <section className={styles.analytics} data-analytics="televend-v3">
    <header className={styles.header}><div><h1>Analytics</h1><p>Explore and compare sales, vends, reliability and machine performance across periods.</p></div><button disabled={!data} onClick={exportCsv} type="button">Export CSV</button></header>
